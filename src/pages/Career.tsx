      ...
      <footer className="bg-background py-16 border-t">
        <div className="container mx-auto px-6 text-center">
          <div className="flex gap-8 justify-center mb-8 text-sm flex-wrap">
            ...
            <a href="https://buymeacoffee.com/priyata/posts" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
              Audio Posts
            </a>
